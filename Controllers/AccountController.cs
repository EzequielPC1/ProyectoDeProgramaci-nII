...
public class AccountController : ControllerBase
{
    ...
    public AccountController(
        ...
        SignInManager<ApplicationUser> signInManager, // Agregado
        RoleManager<IdentityRole> roleManager, // Corregido a IdentityRole
        IConfiguration configuration)
    {
        _userManager = userManager;
        _signInManager = signInManager; // Inicializado
        _roleManager = roleManager; // Corregido
